...
from ccaudit.config.categories import categorize
from ccaudit.ingest.records import AttachmentRecord
...
class TurnWrite:
    ...
    Passed in rather than imported from :mod:`ccaudit.model.attribute` so this module stays a
