...
_LOGGER = logging.getLogger("claude_cost_tracker.capture")
...
def queue_path() -> Path:
    return ccost_home() / QUEUE_FILENAME
...
def enqueue(
    ...
    try:
        ...
        # $CCOST_HOME/ccost.log, and the session stays analysable from its own records. The
...
def _spawn_worker() -> None:
    ...
    subprocess.Popen(
        [sys.executable, "-m", "claude_cost_tracker", "_process_queue"],
