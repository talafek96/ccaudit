...
from claude_cost_tracker.config import MissingThresholdError, Pricing
...
def classify_session(
    ...
    *,
    ...
    detected there (see :mod:`claude_cost_tracker.model.invalidation`). It is what turns a carried item's
