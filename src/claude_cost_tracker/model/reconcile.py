...
A violation **raises**. It is a defect in claude-cost-tracker, not in the user's session, and the tool
...
def reconcile(
    ...
    *,
    ...
    Raises :class:`~claude_cost_tracker.cli.ReconciliationError` if the arithmetic cannot be made to
