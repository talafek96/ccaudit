...
(function () {
  ...
  Array.prototype.forEach.call(document.querySelectorAll(".expand-btn"), function (button) {
    ...
    button.addEventListener("click", function () {
      ...
      document.dispatchEvent(new CustomEvent("claude-cost-tracker:rows-revealed"));
  ...
  Array.prototype.forEach.call(document.querySelectorAll("figure.chart svg"), function (svg) {
    ...
    function focusOn(node) {
      ...
      // actually All / Users / talafek / projects / claude-cost-tracker / src / render. The breadcrumb is
...
(function () {
  ...
  document.querySelectorAll('[data-section-controls]').forEach(function (controls) {
    ...
    document.addEventListener('claude-cost-tracker:rows-revealed', function () { build(); apply(); });
