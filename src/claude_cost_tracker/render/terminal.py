...
Renders the report-data payload (:mod:`claude_cost_tracker.render.data`) and nothing else. It never
...
string of dollars from :mod:`claude_cost_tracker.money`. That is what makes the terminal, the HTML report,
...
from claude_cost_tracker.money import format_micros, format_share
