...
from claude_cost_tracker.config import Pricing, load_pricing
from claude_cost_tracker.ingest.dedup import DedupResult, dedup_turns
from claude_cost_tracker.ingest.discover import session_title
...
from claude_cost_tracker.model.attribute import AttributionResult, attribute_session
from claude_cost_tracker.model.policy import DEFAULT_POLICY
from claude_cost_tracker.model.reconcile import Reconciliation, reconcile
from claude_cost_tracker.model.residency import Timeline, build_timeline
...
def analyse_transcript(
    ...
    *,
    ...
    Raises :class:`~claude_cost_tracker.model.reconcile.ReconciliationError` if the breakdown does not add
...
class SessionContribution:
    ...
    def check_reconciles(self) -> None:
        ...
        :func:`~claude_cost_tracker.model.reconcile.reconcile` from what the attributions leave unexplained,
